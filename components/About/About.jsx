...
function About({handleContact}) {
  return (
    <section id='About' className=' mx-auto max-w-7xl flex lg:flex-row sm:flex-row flex-col-reverse sm:items-center sm:justify-center justify-evenly gap-4 sm:py-[100px] py-[50px] h-[100vh] max-h-[700px] px-2 bg-purple-900/10 w-full'>
